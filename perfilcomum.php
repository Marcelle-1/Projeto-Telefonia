...
<body>
    ...
    <form class="FORM" action="saveEditComum.php" method="POST" >
    <div class="container">
        <div class="form">
            ...
            <div class="input-box"> 
                ...
                <input id="nome" type="text" name="nome" value='<?php echo $nome ?>' placeholder="Digite seu nome" required readonly>
            </div>    
            <div class="input-box"> 
                <label for="datdaNasc"> Data de Nascimento </label>
                <input id="dataNasc" type="date" name="dataNasc" value='<?php echo $data_nasc ?>' placeholder="Digite sua Data de Nascimento" required readonly>
            </div>  
            ...
            <div class="input-box"> 
                ...
                <input id="cpf" type="text" name="cpf" value='<?php echo $cpf ?>' placeholder="Digite seu CPF" required readonly>
            </div>  
            <div class="input-box"> 
